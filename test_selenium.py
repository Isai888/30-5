...
driver = webdriver.Chrome(executable_path="C:\\Users\\user\\PycharmProjects\\30-5\\chromedriver.exe")
...
pytest.driver = webdriver.Chrome('C:\\Users\\user\\PycharmProjects\\30-5\\chromedriver.exe')
